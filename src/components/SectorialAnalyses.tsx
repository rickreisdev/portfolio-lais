...
import { Download, FileText, Cpu, Truck, Wheat, Factory } from "lucide-react";
  ...
  const analyses = [
    {
      ...
      icon: Cpu,
      summary: "Análise especializada em empresas de tecnologia, considerando ativos intangíveis, modelo de receita recorrente e projeções de crescimento exponencial em mercados digitais.",
      insights: ["Avaliação de SaaS e plataformas", "Análise de burn rate e runway", "Modelagem de crescimento viral"],
    ...
    },
    {
      ...
      icon: Truck,
      summary: "Expertise em análise de empresas de transporte e logística, avaliando frota, rotas estratégicas, custos operacionais e tendências de sustentabilidade no setor.",
      insights: ["Análise de depreciação de frota", "Otimização de rotas e custos", "Impacto de combustíveis e pedágios"],
    ...
    },
    {
      ...
      icon: Wheat,
      summary: "Análise profunda do agronegócio brasileiro, considerando sazonalidade, commodities, sustentabilidade e tecnologia aplicada ao campo para decisões de crédito assertivas.",
      insights: ["Análise de safra e produtividade", "Gestão de risco climático", "Tecnologia agrícola (AgTech)"],
    ...
    },
    {
      ...
      icon: Factory,
      summary: "Experiência sólida na análise de empresas industriais, avaliando cadeia produtiva, eficiência operacional, automação e posicionamento competitivo no mercado nacional e internacional.",
      insights: ["Análise de capacidade produtiva", "Otimização de processos", "Competitividade e margem"],
      tags: ["Manufatura", "Automação", "Exportação", "Indústria 4.0"]
    }
  ];

  const handleDownloadAnalysis = (analysisId: number) => {
    // Simular download do PDF da análise setorial
    console.log(`Downloading sectorial analysis ${analysisId} PDF...`);
            ...
            {analyses.map((analysis, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-4">
                    <h4 className="font-semibold text-elegant text-sm mb-2">Principais Insights:</h4>
